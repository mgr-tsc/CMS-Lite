...
var storageConnectionString = configuration.GetConnectionString("AzureStorage:ConnectionString") ?? throw new InvalidOperationException("Azure Storage connection string is not configured.");
var containerName = configuration["AzureStorage:Container"] ?? "cms";
var dbPath = configuration.GetConnectionString("Database:Path") ?? "cmslite.db";
